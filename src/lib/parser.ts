/**
 * @fileOverview Institutional Deterministic Ingestion Hub v29.0.
 * FIXED: Arrival Order Protocol - Preserves relative line order for multiline statements.
 * FIXED: Script Isolation - Routes non-local script lines to English in arrival order.
