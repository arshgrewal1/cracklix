...
/**
 * @fileOverview Search Center v8.1.
 * FIXED: Explicitly typed cloneElement calls to resolve build failures.
 */
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                 ...
                 <div className="grid grid-cols-1 gap-3">
                    {searchResults.length > 0 ? searchResults.map((res, i) => (
                      <SearchResultItem key={i} title={res.title} category={res.type} href={res.href} icon={res.icon as ReactElement<any>} />
                    )) : !isLoading && (
...
function SearchResultItem({ title, category, href, icon }: { title: string, category: string, href: string, icon: ReactElement<any> }) {
   return (
