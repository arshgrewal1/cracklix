...
/**
 * @fileOverview Institutional Access Enforcer v24.0.
 * HARDENED: Real-time dynamic access validation against the Pass Registry.
 */
...
export default function InstructionsPage() {
  ...
  useEffect(() => {
    if (mock?.languageMode) setPrefLang(mock.languageMode);
  }, [mock]);
