...
/**
 * @fileOverview Strict Category Explorer v16.0.
    ...
    <div className="flex flex-col min-h-screen bg-slate-50/50 font-body text-left">
      ...
      <main className="container mx-auto px-4 py-12 max-w-7xl">
        <div className="text-left mb-12 space-y-3">
          ...
          <p className="text-slate-600 font-medium text-sm md:text-lg max-w-2xl">Select a category to explore official exams and mock tests.</p>
        </div>
             ...
             <Link key={cat.id} href={`/exams/category/${cat.id}`}>
                <Card className="border-none shadow-xl hover:shadow-4xl transition-all duration-500 rounded-[2rem] bg-white group overflow-hidden h-full flex flex-col p-6">
                   <div className="flex justify-between items-start mb-6">
                      <div className="h-12 w-12 rounded-xl bg-slate-50 flex items-center justify-center text-primary shadow-inner"><Zap className="h-6 w-6" /></div>
