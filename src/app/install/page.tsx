              ...
              >
                 ...
                 <div className="relative py-2 flex flex-col items-center">
                    <h1 className="flex flex-col items-center justify-center font-black tracking-tighter leading-[0.85] md:leading-[0.8] select-none antialiased italic">
                       ...
                       <span className="text-[52px] md:text-[100px] lg:text-[120px] text-primary uppercase mt-[-10px] md:mt-[-15px]">Setup.</span>
                    </h1>
                 </div>
                 ...
                 <div className="max-w-xl mx-auto space-y-8 px-4">
                    ...
                    <div className="flex flex-col items-center justify-center gap-6 pt-4">
                       {isInstalled ? (
                         ...
                         <Button 
                           onClick={installApp}
                           className="h-16 md:h-20 w-full max-w-[340px] bg-primary hover:bg-blue-700 text-white rounded-2xl md:rounded-[1.5rem] shadow-4xl gap-4 md:gap-5 group transition-all active:scale-95 border-none px-8"
                         >
                            <Smartphone className="h-6 w-6 md:h-8 md:w-8 group-hover:rotate-12 transition-transform" />
                            <div className="flex flex-col items-start text-left">
                               <span className="font-black tracking-tight text-lg md:text-2xl leading-none">Install App</span>
                               <span className="text-[8px] md:text-[10px] opacity-60 font-bold mt-1 uppercase tracking-widest">Authorize Sync</span>
                            </div>
                            <ChevronRight className="h-4 w-4 md:h-5 md:w-5 ml-auto opacity-30 group-hover:translate-x-1 transition-transform" />
                         </Button>
                       )}
                    </div>
                 </div>
