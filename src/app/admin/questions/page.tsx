         ...
         <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[100] animate-in slide-in-from-bottom-12 duration-500 w-[95vw] max-w-3xl">
            <div className="bg-[#0F172A] text-white px-8 py-5 rounded-[2.5rem] shadow-5xl flex items-center justify-between border border-white/10 backdrop-blur-xl relative">
               <div className="flex items-center gap-5">
                  <div className="h-12 w-12 bg-primary/20 rounded-2xl flex items-center justify-center text-primary font-bold text-lg shadow-xl">{selectedIds.length}</div>
                  <div>
                    <p className="text-[11px] font-bold leading-none">Questions staged</p>
                    <p className="text-[8px] font-bold text-slate-500 mt-1.5">Batch management protocol</p>
                  </div>
               </div>
               <div className="flex items-center gap-3">
                  ...
                  <button onClick={() => setSelectedIds([])} className="p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all active:scale-90 text-slate-400 hover:text-white bg-transparent border-none cursor-pointer" title="Clear selection">
                     <X className="h-5 w-5" />
                  </button>
               </div>
            </div>
