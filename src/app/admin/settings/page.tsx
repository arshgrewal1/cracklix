...
const DEFAULT_DISTRIBUTION: DistributionSettings = {
  ...
  canonicalUrl: "https://cracklix.in",
  updatedAt: null
};

const DEFAULT_BRANDING: BrandingSettings = {
  websiteUrl: "https://cracklix.in",
  logoUrl: "",
  faviconUrl: "",
  footerText: "Punjab's most advanced government exam portal.",
  verificationUrl: "https://cracklix.in/results/view?id=",
  qrCodeUrl: "",
  certificateBgUrl: "",
  digitalStampUrl: "",
           ...
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
              <div className="lg:col-span-8 space-y-12">
                 <section className="space-y-6">
                    ...
                    <Card className="border-none shadow-xl bg-white p-6 md:p-8 space-y-6 rounded-[2rem] border border-slate-50">
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <FormNode label="Primary Website URL" value={brandData.websiteUrl} onChange={v => setBrandData({...brandData, websiteUrl: v})} placeholder="https://cracklix.in" />
                       </div>
                 ...
                 <section className="space-y-6">
                    ...
                    <Card className="border-none shadow-xl bg-white p-6 md:p-8 space-y-6 rounded-[2rem] border border-slate-50">
                       <FormNode label="Verification Base URL" value={brandData.verificationUrl} onChange={v => setBrandData({...brandData, verificationUrl: v})} placeholder="https://cracklix.in/results/view?id=" />
              ...
              <div className="lg:col-span-8 space-y-12">
                 <section className="space-y-6">
                    ...
                    <Card className="border-none shadow-xl bg-white p-6 md:p-8 space-y-6 rounded-[2rem] border border-slate-100">
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <FormNode label="Primary Website URL" value={distData.primaryWebsiteUrl} onChange={v => setDistData({...distData, primaryWebsiteUrl: v})} placeholder="https://cracklix.in" />
                          <FormNode label="Install Landing URL" value={distData.installUrl} onChange={v => setDistData({...distData, installUrl: v})} placeholder="https://cracklix.in/install" />
                       </div>
                    </Card>
                 </section>
                    ...
                    <Card className="border-none shadow-xl bg-white p-6 md:p-8 space-y-6 rounded-[2rem] border border-slate-100">
                       ...
                       <div className="space-y-2">
                          ...
                          <Textarea 
                             ...
                             className="min-h-[300px] bg-slate-50 border-none rounded-xl"
                          />
                       </div>
                    </Card>
                 </section>
