...
/**
 * @fileOverview Official Institutional Scorecard v3.0.
 * Rebuilt from scratch as a professional exam report.
 * HIERARCHY: 1. Net Score (Biggest), 2. Accuracy, 3. Percentile, 4. Rank (Small Card).
 */
export default function ShareableResultCard({ data, rank, totalCandidates }: ShareableResultCardProps) {
  ...
  return (
    ...
    >
      {/* 1. PROFESSIONAL HEADER HUB - 3X LOGO */}
      <div className="relative z-10 px-16 pt-16 flex justify-between items-start border-b border-slate-100 pb-12">
         <div className="space-y-6">
            ...
            <div className="space-y-1">
               ...
               <p className="text-sm font-bold text-slate-400 uppercase tracking-[0.4em]">Candidate Registry Profile</p>
            </div>
         </div>
         <div className="text-right space-y-4">
            ...
            <div className="space-y-1">
               <p className="text-xs font-black text-slate-400 uppercase tracking-widest">Date of Audit</p>
      ...
      <div className="px-16 pt-10">
         <div className="bg-slate-50 rounded-[2rem] p-10 flex justify-between items-center border border-slate-100 shadow-inner">
            <div className="space-y-2">
               <p className="text-xs font-black text-slate-400 uppercase tracking-widest">Examination Title</p>
         ...
         <div className="col-span-7">
            <Card className="h-full border-none bg-[#0B57D0] text-white rounded-[3rem] p-12 shadow-2xl flex flex-col items-center justify-center text-center relative overflow-hidden">
               ...
               <div className="mt-10 px-10 py-3 bg-white/10 rounded-2xl border border-white/10">
                  <p className="text-2xl font-bold">Grade: {data.grade || 'A'}</p>
               </div>
            </Card>
         </div>
         ...
         <div className="col-span-5 grid grid-cols-1 gap-6">
            ...
            <Card className="border border-slate-100 shadow-xl rounded-[2.5rem] bg-white p-8 flex items-center justify-between group overflow-hidden">
               ...
               <div className="text-right">
                  <p className="text-[10px] font-bold text-slate-300 uppercase tracking-tight">Active Candidates</p>
      ...
      {data.subjectAnalysis && (
         <div className="px-16 pt-10 space-y-4">
            <p className="text-xs font-black text-slate-400 uppercase tracking-widest ml-2">Subject Mastery Ledger</p>
            <div className="bg-white border-2 border-slate-50 rounded-[2.5rem] overflow-hidden shadow-sm">
               <table className="w-full border-collapse">
                  <thead className="bg-slate-50">
                     <tr className="h-16">
                        <th className="px-10 text-left font-black text-xs text-slate-400 uppercase">Preparation Vertical</th>
                        <th className="px-10 text-center font-black text-xs text-slate-400 uppercase">Progress</th>
                        <th className="px-10 text-right font-black text-xs text-slate-400 uppercase">Points</th>
                     </tr>
                  </thead>
      ...
      <div className="mt-auto bg-slate-50 h-[220px] px-16 flex items-center justify-between border-t border-slate-200">
         <div className="flex items-center gap-10">
            ...
            <div className="space-y-1 text-left">
               <p className="text-3xl font-black text-[#0B57D0] uppercase tracking-tight">Audit Result</p>
               <p className="text-lg font-bold text-slate-400 uppercase tracking-widest uppercase">WWW.CRACKLIX.IN</p>
            </div>
         </div>
         <div className="text-right space-y-4">
            <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Institutional Merit Index</p>
            <div className="inline-flex items-center gap-4 text-[#0B57D0] bg-[#0B57D0]/5 px-8 py-3 rounded-2xl border border-[#0B57D0]/10 shadow-sm">
               ...
               <span className="text-xl font-black uppercase tracking-[0.2em]">Registry Synchronized</span>
            </div>
         </div>
      </div>
    </div>
