  ...
  return (
    <div className="flex flex-col gap-0 bg-slate-100">
      ...
      >
        ...
        <div className="px-20 pt-20 flex justify-between items-start">
        ...
        <div className="px-20 mt-24 grid grid-cols-3 gap-10">
        ...
        <div className="px-20 mt-16">
           <div className="bg-[#F8FAFC] border border-slate-100 rounded-[3rem] p-12 flex items-center justify-between shadow-inner">
        ...
        <div className="mt-auto bg-[#0F172A] p-20 flex items-center justify-between text-white">
      ...
      >
        ...
        <div className="px-20 pt-20 space-y-16">
           <div className="flex justify-between items-end border-b-4 border-slate-100 pb-12">
              ...
              <div className="h-12 relative grayscale opacity-20">
           ...
           <section className="space-y-6">
              ...
              <div className="bg-[#F8FAFC] p-12 rounded-[3rem] border border-slate-100 relative overflow-hidden">
                 ...
                 <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y-2 divide-slate-100">
                       {subjects.length > 0 ? subjects.map((s, idx) => (
                          <tr key={idx} className="h-20 hover:bg-slate-50 transition-colors">
           ...
           <div className="grid grid-cols-2 gap-12">
              <section className="space-y-8">
                 ...
                 <div className="space-y-8 p-12 bg-slate-50 rounded-[3rem] border border-slate-100">
        ...
        <div className="mt-auto border-t-2 border-slate-100 p-20 flex items-center justify-between text-slate-300">
           <div className="flex items-center gap-4">
...
function Metric({ label, val, icon, color, bg }: any) {
   return (
      <div className="bg-white border-2 border-slate-50 rounded-[2.5rem] p-10 shadow-lg flex flex-col items-center justify-center text-center space-y-5 group hover:border-primary/20 transition-all">
         <div className={cn("h-16 w-16 rounded-2xl flex items-center justify-center shadow-inner transition-transform group-hover:scale-110", bg, color)}>
            {React.isValidElement(icon) ? React.cloneElement(icon as React.ReactElement, { className: "h-8 w-8" }) : null}
         </div>
         <div className="space-y-2">
            <p className="text-slate-400 font-black uppercase tracking-[0.3em] text-[10px]">{label}</p>
            <p className={cn("text-4xl font-black tracking-tighter tabular-nums", color)}>{val}</p>
         </div>
      </div>
   );
}
...
function DataNode({ label, val, color }: any) {
   return (
      <div className="text-center space-y-2">
         <p className="text-slate-400 font-black uppercase tracking-widest text-[11px]">{label}</p>
         <p className={cn("text-4xl font-black tabular-nums leading-none", color)}>{val}</p>
      </div>
   );
}
...
function MetricValue({ label, val }: any) {
   return (
      <div className="flex items-center justify-between border-b border-slate-200 pb-2">
         ...
         <span className="text-xl font-black text-[#0F172A] tabular-nums tracking-tighter">{val}</span>
      </div>
   );
}
