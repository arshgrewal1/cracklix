      ...
      <div className="flex items-center justify-between px-10 py-12 border-b-2 border-slate-100 bg-slate-50/20">
         <div className="flex items-center gap-8">
            ...
            <div className="space-y-1">
               ...
               <p className="text-base font-bold text-primary tracking-tight">Smart Preparation. Better Results.</p>
            </div>
         </div>
         <div className="text-right space-y-2">
            <p className="text-2xl font-black text-[#0F172A] tracking-tight">Performance Report</p>
      ...
      <div className="p-10 space-y-10">
         ...
         <div className="grid grid-cols-[1fr_260px] gap-10">
            <div className="bg-slate-50 rounded-[2.5rem] p-10 border border-slate-100 flex flex-col justify-between shadow-inner">
               <div className="space-y-2">
                  <p className="text-[10px] font-bold text-primary tracking-tight">Candidate Identity</p>
                  <h1 className="text-4xl font-black text-[#0F172A] leading-tight break-word">{studentName}</h1>
                  ...
                  <table className="w-full text-left">
                     <thead>
                        <tr className="bg-slate-50 border-b border-slate-100">
                           <th className="px-10 py-5 font-bold text-[11px] text-slate-500 tracking-tight">Subject Hub</th>
                           <th className="px-6 py-5 font-bold text-[11px] text-center text-slate-500 tracking-tight">Net Score</th>
                           <th className="px-6 py-5 font-bold text-[11px] text-center text-slate-500 tracking-tight">Accuracy %</th>
                        </tr>
                     </thead>
         ...
         <div className="pt-20 mt-auto border-t border-slate-100 flex items-center justify-between">
            ...
            <div className="text-right space-y-2">
               ...
               <p className="text-[11px] font-black tracking-widest text-slate-300 uppercase">www.cracklix.in</p>
            </div>
         </div>
      </div>
    </div>
...
function KPIBox({ label, val, color }: any) {
   return (
      <div className="bg-white border border-slate-100 p-8 rounded-[2rem] flex flex-col gap-3 h-40 justify-center shadow-xl border-t-4 border-t-primary">
         <p className="text-[10px] font-black text-slate-400 tracking-tight">{label}</p>
...
function CountPill({ label, val, color }: any) {
   return (
      <div className={cn("p-6 rounded-[1.5rem] flex flex-col items-center justify-center gap-1 shadow-sm", color)}>
         ...
         <span className="text-[9px] font-bold tracking-tight opacity-70">{label}</span>
      </div>
   )
}
