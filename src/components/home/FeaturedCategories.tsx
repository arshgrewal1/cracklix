      ...
      <div className="max-w-[1440px] 2xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 space-y-6 md:space-y-16">
        ...
        <div className="space-y-2 text-left">
          <div className="flex items-center gap-2 md:gap-4">
             ...
             <h2 className="text-[clamp(24px,4vw,40px)] font-black tracking-tight leading-none text-[#0F172A]">Choose Category</h2>
          </div>
          <p className="max-w-2xl text-[clamp(13px,1.5vw,18px)] font-medium text-slate-500">Explore verified preparation hubs curated for state and central recruitments.</p>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-3 md:gap-8 lg:gap-10">
          {catLoading ? (
