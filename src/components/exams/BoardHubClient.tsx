      ...
      <section className="bg-white border-b border-slate-100 pt-10 pb-12 md:pt-16 md:pb-24 relative overflow-hidden">
         ...
         <div className="container mx-auto px-4 md:px-12 max-w-7xl relative z-10 space-y-10">
            <div className="flex items-center gap-4">
               ...
               <Badge className="bg-primary/10 text-primary border-none px-4 py-1.5 rounded-full font-black text-[9px] md:text-[11px] uppercase tracking-widest shadow-sm">Verified Authority Hub</Badge>
            </div>
                       ...
                       <Link href={`/exams/view?id=${exam.id}`}>
                          <Card className="border border-[#E5E7EB] shadow-xl hover:shadow-5xl transition-all duration-500 rounded-[2.5rem] md:rounded-[3.5rem] bg-white group overflow-hidden h-full flex flex-col p-8 md:p-12 text-left relative">
                             ...
                             <div className="space-y-6 flex-1 text-left relative z-10">
                                <h3 className="text-xl md:text-[32px] font-black text-[#0F172A] leading-[1.1] group-hover:text-primary transition-colors tracking-tight uppercase">{exam.name}</h3>
                             ...
                             <div className="mt-12 pt-4 relative z-10">
                                <Button className="w-full h-14 md:h-18 rounded-[20px] bg-[#0F172A] hover:bg-black text-white group-hover:bg-primary transition-all font-black uppercase text-[10px] md:text-xs tracking-widest border-none shadow-3xl gap-3">
