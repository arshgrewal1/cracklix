...
/**
 * @fileOverview Production-grade Calendar node v12.3 (Type Hardened).
 * FIXED: Chevron component now correctly handles all orientations to satisfy react-day-picker v9.
 */
function Calendar({
  className,
  classNames,
