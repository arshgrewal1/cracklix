...
/**
 * @fileOverview Calendar Component v5.2 - Next.js 15 + react-day-picker v9 Ready.
 * FIXED: Removed IconLeft/IconRight and replaced with v9 compliant Chevron component.
 */
function Calendar({
  className,
  classNames,
