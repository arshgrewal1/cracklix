...
/**
 * @fileOverview Calendar Component v8.2.
 * FIXED: Strictly aligned with react-day-picker v9 standards by using required Chevron components and orientation types.
 */
function Calendar({
  className,
  classNames,
