...
/**
 * @fileOverview Calendar Component v8.0.
 * FIXED: Updated orientation property usage to strictly follow react-day-picker v9.
 * FIXED: Replaced deprecated Icon components with standard v9 Chevron mappings.
 */
function Calendar({
  className,
  classNames,
